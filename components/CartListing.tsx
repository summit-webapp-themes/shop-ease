            ...
            <div className="col-12">
              <div className="row justify-content-between">
                <div className="col-md-4 text-left">
                  <button
                    type="button"
                    className="w-75 checkout_button mb-3 text-uppercase py-2 px-1 cart-new-btns standard_button"
                ...
                <div className="col-md-4 text-right">
                  <Link href="/checkout">
                    <button
                      type="button"
                      className="w-75 checkout_button mb-3 text-uppercase py-2 px-1 standard_button_filled"
